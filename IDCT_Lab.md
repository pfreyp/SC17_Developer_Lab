...
1. Open the kernel file by double clicking the icon **Project Explorer -&gt; src -&gt; krnl_idct.cpp**.__

    ![](./idctFigures/OutlineKernel.PNG)
...
1. Open the **Application Timeline** of the **Emulation-HW** run.  
	...
	Locate the definition of **NUM_SCHED** through the **Outline** viewer in the **idct.cpp** host code.
